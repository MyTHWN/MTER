...
fin_uif_train_entry = open('../yelp_restaurant_recursive_entry_sigir/yelp_recursive_train.entry', encoding='UTF-8')
fin_uif_test_entry = open('../yelp_restaurant_recursive_entry_sigir/yelp_recursive_test.entry', encoding='UTF-8')
fin_uifw_train_entry = open('../yelp_restaurant_recursive_entry_sigir/yelp_recursive_train.uifwords_entry', encoding='UTF-8')
fin_uifw_test_entry = open('../yelp_restaurant_recursive_entry_sigir/yelp_recursive_test.uifwords_entry', encoding='UTF-8')
...
(G1,G2,G3,U0,U1,U2,I0,I1,I2,F0,F1,F2,F3,W0,W1,W2) = tsmtr.learn_HAT_SGD_adagrad(case, sps_tensor_useritemf, sps_tensor_userwordf, sps_tensor_itemwordf, 
								   ...
								   num_iter, lr=0.1, dis=False, cost_function='abs', G1_known=None, G2_known=None, G3_known = None, U0_known=None, U1_known=None, 
