...
An parallel implementation of MTER based on the idea of parameter server. Directly run MTER_tripletensor_tucker.py in parallel implementation to test our MTER model by tunning hyper parameters. The learned model is stored in Results. The processed Yelp dataset is included in yelp_restaurant_recursive_entry_sigir. 
